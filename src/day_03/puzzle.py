...
from src.day_03.spiral_memory import SpiralMemory
...
def puzzle_01() -> None:
    ...
    :return: None; Answer should be 430.
    """

    memory = SpiralMemory()
    memory.create_squares(PUZZLE_INPUT)
    print_puzzle_solution(memory.data_distance)
...
def puzzle_02() -> None:
    ...
    :return: None; Answer should be 312453.
    """

    memory = SpiralMemory()
    memory.stress_test(PUZZLE_INPUT)
    print_puzzle_solution(memory.current_square)
