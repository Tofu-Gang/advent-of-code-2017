...
def puzzle_01() -> None:
    ...
    group is assigned a score which is one more than the score of the group that
    ...
    :return: None; Answer should be 12396.
    """
    ...
    with open(INPUT_FILE_PATH, "r") as f:
        ...
        print_puzzle_solution(stream.total_score)
...
def puzzle_02() -> None:
    ...
    :return: None; Answer should be 6346.
    """
    ...
    with open(INPUT_FILE_PATH, "r") as f:
        ...
        stream.process_stream()
        print_puzzle_solution(stream.garbage_count)
