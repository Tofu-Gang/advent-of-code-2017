...
from src.day_06.memory import Memory
...
def puzzle_01() -> None:
    ...
    :return: None; Answer should be 11137.
    """

    print_puzzle_solution(memory.cycles)
...
def puzzle_02() -> None:
    ...
    :return: None; Answer should be 1037.
    """

    print_puzzle_solution(memory.loop_size)
