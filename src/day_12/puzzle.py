...
def puzzle_01() -> None:
    ...
    :return: None; Answer should be 239.
    """

    with open(INPUT_FILE_PATH, "r") as f:
        lines = f.readlines()
        groups = Groups(lines)
        print_puzzle_solution(groups.get_group_size("0"))
...
def puzzle_02() -> None:
    ...
    :return: None; Answer should be 215.
    """

    with open(INPUT_FILE_PATH, "r") as f:
        lines = f.readlines()
        groups = Groups(lines)
        print_puzzle_solution(groups.groups_count)
