...
def puzzle_01() -> None:
    ...
    :return: None; Answer should be hmvwl.
    """

    with open(INPUT_FILE_PATH, "r") as f:
        lines = f.readlines()
        tower = Tower(lines)
        print_puzzle_solution(tower.get_bottom_program().name)
...
def puzzle_02() -> None:
    ...
    :return: None; Answer should be 1853.
    """

    with open(INPUT_FILE_PATH, "r") as f:
        lines = f.readlines()
        tower = Tower(lines)
        print_puzzle_solution(tower.get_balanced_weight())
