...
def puzzle_01() -> None:
    ...
    :return: None; Answer should be 8204.
    """

    print_puzzle_solution(Disk(KEY_STRING).used_count)
...
def puzzle_02() -> None:
    ...
    :return: None; Answer should be 1089.
    """

    print_puzzle_solution(Disk(KEY_STRING).groups_count)
